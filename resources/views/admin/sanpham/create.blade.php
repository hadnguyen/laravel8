        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="gia" id="gia" aria-describedby="helpId"
                        placeholder="Giá">
                    @error('gia')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="uutien" id="uutien" aria-describedby="helpId"
                        placeholder="">
                    @error('uutien')
                        <div class="help-text text-danger">{{ $message }}</div>
                    @enderror
