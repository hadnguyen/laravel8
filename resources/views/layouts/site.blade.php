            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="{{url('site')}}/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li @class(['active'=>Route::currentRouteName()=='home'])><a href="{{route('home')}}">Home</a></li>
                            <li @class(['active'=>Route::currentRouteName()=='shop'])><a href="{{route('shop')}}">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./shop-details.html">Shop Details</a></li>
                                    {{-- <li><a href="./shoping-cart.html">Shoping Cart</a></li> --}}
